module "sample" {
  ...
  landing_zone_components = {
      ...
      landing_zone_organization_accounts = "s3://terraform-aws-landing-zone/example/landing_zone_organization_accounts/default.tfvars"
      landing_zone_organization_unit = "s3://terraform-aws-landing-zone/example/landing_zone_organization_unit/default.tfvars"
      landing_zone_organization_policy = "s3://terraform-aws-landing-zone/example/landing_zone_organization_policy/default.tfvars"
      landing_zone_organization_policy_attachment = "s3://terraform-aws-landing-zone/example/landing_zone_organization_policy_attachment/default.tfvars"
  }
  region = "us-east-1"

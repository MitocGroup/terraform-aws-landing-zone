landing_zone_components = {
  ...
  # landing_zone_vpc_peering_connection         = "s3://terraform-aws-landing-zone/mycompany/landing_zone_vpc_peering_connection/*.tfvars"
  ...
  # landing_zone_route_pcx                      = "s3://terraform-aws-landing-zone/mycompany/landing_zone_route_pcx/*.tfvars"
  # landing_zone_tgw_route                      = "s3://terraform-aws-landing-zone/mycompany/landing_zone_tgw_route/*.tfvars"
  # landing_zone_tgw_route_table                = "s3://terraform-aws-landing-zone/mycompany/landing_zone_tgw_route_table/*.tfvars"
  # landing_zone_tgw_route_table_association    = "s3://terraform-aws-landing-zone/mycompany/landing_zone_tgw_route_table_association/*.tfvars"
  # landing_zone_tgw_route_table_propagation    = "s3://terraform-aws-landing-zone/mycompany/landing_zone_tgw_route_table_propagation/*.tfvars"
  # landing_zone_tgw_vpc_attachment             = "s3://terraform-aws-landing-zone/mycompany/landing_zone_tgw_vpc_attachment/*.tfvars"
  # landing_zone_tgw_vpc_attachment_accepter    = "s3://terraform-aws-landing-zone/mycompany/landing_zone_tgw_vpc_attachment_accepter/*.tfvars"
  ...
  landing_zone_config_aggregate_authorization   = "../../../mitocgroup_tfvars/landing_zone_config_aggregate_authorization/*.tfvars"
}
...
landing_zone_providers = {
  ...
  eurechean = {
    account_id = "643695102975"
    region     = "us-east-1"
  },
  vcalmic = {
    account_id = "300672210419"
    region     = "us-east-1"
  }
}

landing_zone_components = {
  ...
  landing_zone_config_aggregate_authorization       = "s3://terraform-aws-landing-zone/mycompany/landing_zone_config_aggregate_authorization/*.tfvars"
  landing_zone_config_config_rule                   = "s3://terraform-aws-landing-zone/mycompany/landing_zone_config_config_rule/*.tfvars"
  landing_zone_config_configuration_aggregator      = "s3://terraform-aws-landing-zone/mycompany/landing_zone_config_configuration_aggregator/*.tfvars"
  landing_zone_config_configuration_recorder        = "s3://terraform-aws-landing-zone/mycompany/landing_zone_config_configuration_recorder/*.tfvars"
  landing_zone_config_configuration_recorder_status = "s3://terraform-aws-landing-zone/mycompany/landing_zone_config_configuration_recorder_status/*.tfvars"
  landing_zone_config_delivery_channel              = "s3://terraform-aws-landing-zone/mycompany/landing_zone_config_delivery_channel/*.tfvars"
  landing_zone_config_organization_custom_rule      = "s3://terraform-aws-landing-zone/mycompany/landing_zone_config_organization_custom_rule/*.tfvars"
  landing_zone_config_organization_managed_rule     = "s3://terraform-aws-landing-zone/mycompany/landing_zone_config_organization_managed_rule/*.tfvars"
  ...
  landing_zone_ssm_association_by_instance_id       = "s3://terraform-aws-landing-zone/mycompany/landing_zone_ssm_association_by_instance_id/*.tfvars"
  landing_zone_ssm_association_by_targets           = "s3://terraform-aws-landing-zone/mycompany/landing_zone_ssm_association_by_targets/*.tfvars"
  ...
  landing_zone_sso                                  = "s3://terraform-aws-landing-zone/mycompany/landing_zone_sso/*.tfvars"
  ...
  landing_zone_vpc_endpoint_gateway                 = "s3://terraform-aws-landing-zone/mycompany/landing_zone_vpc_endpoint_gateway/*.tfvars"
  landing_zone_vpc_endpoint_interface               = "s3://terraform-aws-landing-zone/mycompany/landing_zone_vpc_endpoint_interface/*.tfvars"
